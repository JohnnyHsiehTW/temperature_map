...
export default function Navbar() {
  return (
    <>
      <div className="from-theme-cyan to-theme-cyan-light fixed flex w-full justify-center bg-linear-to-b py-2">
        <div className="container flex items-center justify-between">
          <div className="flex flex-1 items-center">
            <img src="src/assets/img/temp_map_logo_sm.png" alt="避暑指南針" className="w-10" />
            <h1 className="text-2xl font-bold tracking-wider text-white">避暑指南針</h1>
          </div>
